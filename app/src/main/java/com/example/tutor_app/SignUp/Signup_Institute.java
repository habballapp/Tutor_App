...
public class  Signup_Institute extends AppCompatActivity {


    private EditText edt_email,edt_password,edt_fullname,edt_contact;
    private String Url_Institute = "http://pci.edusol.co/Login/signup_institute_data.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(Signup_Institute.this , SignIn.class);
                startActivity(back);
            }
        });
    ...
    private void SignupUser() {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, Url_Institute, new Response.Listener<String>() {
            ...
            public void onResponse(String result) {
                ...
                try {
                    ...
                    if (!obj.getString("instituteid").equals("null")) {

                        Toast.makeText( Signup_Institute.this, "Institute Account Created.", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent( Signup_Institute.this, SignIn.class);
                        startActivity(intent);


                    } else {
                        Toast.makeText(Signup_Institute.this, "Username or password is incorrect.", Toast.LENGTH_LONG).show();
                    }
